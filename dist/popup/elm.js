...
var _virtuaCode$bonjwa_programm$Util$srcset = function (items) {
	var maps = A2(
		_elm_lang$core$List$indexedMap,
		F2(
			function (i, item) {
...
var _virtuaCode$bonjwa_programm$Page_PastBroadcast$maximumDate = function (broadcasts) {
	return A2(
...
var _virtuaCode$bonjwa_programm$Page_PastBroadcast$offsetLatest = F2(
...
var _virtuaCode$bonjwa_programm$Page_PastBroadcast$searchPastBroadcasts = F2(
	function (term, broadcasts) {
		var match = function (_p2) {
			var _p3 = _p2;
			var lowerGame = _elm_lang$core$String$toLower(_p3.game);
...
var _virtuaCode$bonjwa_programm$Page_PastBroadcast$filterPastBroadcasts = F2(
	function (today, broadcasts) {
		return A2(
			...
			function (_p4) {
				var _p5 = _p4;
				return A2(_virtuaCode$bonjwa_programm$Util$dateEqual, today, _p5.date);
			},
			broadcasts);
	});
		...
		switch (_p6._0.ctor) {
			...
			default:
				if (_p6._1.ctor === 'Nothing') {
					...
					var offsetDate = A2(_virtuaCode$bonjwa_programm$Util$addDays, offset, _p6._1._0);
					var visiblePastBroadcasts = A2(_virtuaCode$bonjwa_programm$Page_PastBroadcast$filterPastBroadcasts, offsetDate, _p6._0._0);
...
var _virtuaCode$bonjwa_programm$Page_PastBroadcast$view = function (_p10) {
	var _p11 = _p10;
	var _p19 = _p11.search;
	var _p18 = _p11.offset;
	var _p17 = _p11.date;
	var _p16 = _p11.broadcasts;
	var dateString = function (_p12) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(
				...
				function (_p13) {
					return _virtuaCode$bonjwa_programm$Util$formatDate(
						A2(_virtuaCode$bonjwa_programm$Util$addDays, _p18, _p13));
				},
				_p12));
	}(_p17);
	var navigation = function () {
		...
		if (_p14.ctor === 'Nothing') {
			...
			return _virtuaCode$bonjwa_programm$Page_PastBroadcast$viewSearchNavigation(_p14._0);
		}
	}();
	var content = function () {
		var _p15 = _p19;
		if (_p15.ctor === 'Nothing') {
			return A3(_virtuaCode$bonjwa_programm$Page_PastBroadcast$viewContent, _p17, _p18, _p16);
		} else {
			return A2(_virtuaCode$bonjwa_programm$Page_PastBroadcast$viewContentSearch, _p15._0, _p16);
		}
	}();
	var header = {
		ctor: '::',
					...
					_elm_lang$html$Html$img,
					{
						...
						_1: {
							...
							_0: _virtuaCode$bonjwa_programm$Util$srcset(
								{
									ctor: '::',
									_0: '../images/search_48_1x.png',
									_1: {
										ctor: '::',
										_0: '../images/search_48_2x.png',
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
			...
			case 'InitDate':
				return A2(
					...
					A2(
						...
						_virtuaCode$bonjwa_programm$Page_PastBroadcast$requestPastBroadcasts),
					_virtuaCode$bonjwa_programm$Page_PastBroadcast$NoOp);
			case 'ClickedLink':
				return A2(
					_virtuaCode$bonjwa_programm$Util_ops['=>'],
					A2(_virtuaCode$bonjwa_programm$Util_ops['=>'], model, _elm_lang$core$Platform_Cmd$none),
					_virtuaCode$bonjwa_programm$Page_PastBroadcast$OpenTab(_p20._0));
			case 'ClickedBack':
				return A2(
					_virtuaCode$bonjwa_programm$Util_ops['=>'],
					A2(_virtuaCode$bonjwa_programm$Util_ops['=>'], model, _elm_lang$core$Platform_Cmd$none),
				...
				return A2(
					...
					A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								broadcasts: _p21,
								offset: A2(_virtuaCode$bonjwa_programm$Page_PastBroadcast$offsetLatest, model.date, _p21)
							}),
						_elm_lang$core$Platform_Cmd$none),
					_virtuaCode$bonjwa_programm$Page_PastBroadcast$NoOp);
			case 'Search':
				return A2(
					...
					A2(
						...
						_virtuaCode$bonjwa_programm$Page_PastBroadcast$focusSearchField),
					_virtuaCode$bonjwa_programm$Page_PastBroadcast$NoOp);
			case 'CancelSearch':
				return A2(
					_virtuaCode$bonjwa_programm$Util_ops['=>'],
					...
					return A2(
						...
						A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									search: _elm_lang$core$Maybe$Just(_p20._0)
								}),
							_elm_lang$core$Platform_Cmd$none),
						_virtuaCode$bonjwa_programm$Page_PastBroadcast$NoOp);
				}
...
var _virtuaCode$bonjwa_programm$Popup$filterBroadcasts = F2(
	function (today, broadcasts) {
		...
		var ceilingDate = A2(_justinmimbs$elm_date_extra$Date_Extra$ceiling, _justinmimbs$elm_date_extra$Date_Extra$Day, today);
...
var _virtuaCode$bonjwa_programm$Popup$requestDate = A2(_elm_lang$core$Task$perform, _virtuaCode$bonjwa_programm$Popup$ReceiveDate, _elm_lang$core$Date$now);
var _virtuaCode$bonjwa_programm$Popup$ReceiveInitialDate = function (a) {
	return {ctor: 'ReceiveInitialDate', _0: a};
};
...
var Elm = {};
Elm['Popup'] = Elm['Popup'] || {};
if (typeof _virtuaCode$bonjwa_programm$Popup$main !== 'undefined') {
    _virtuaCode$bonjwa_programm$Popup$main(Elm['Popup'], 'Popup', undefined);
}
